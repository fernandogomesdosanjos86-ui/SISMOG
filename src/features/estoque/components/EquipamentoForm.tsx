...
const EquipamentoForm: FC<Props> = ({ initialData, onSuccess }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-4 pb-1 border-b">Classificação</h3>
            ...
            <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-4 pb-1 border-b">Detalhes do Item</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 w-full rounded-md border-gray-300 shadow-sm p-2 border focus:border-blue-500 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-500"
                                value={quantidade}
